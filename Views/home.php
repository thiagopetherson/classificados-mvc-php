			...
			<div class="row">
				...
				<div class="col-sm-9">
					...
					<ul class="pagination">
						...
						<li class="<?php echo ($p==$q)?'active':''; ?>"><a href="<?php echo BASE_URL; ?>home/index/<?php					
						echo $q;
						?>/<?php echo !empty($filtros['categoria']) ? $filtros['categoria'] : 'sem-categoria'; ?>/<?php echo !empty($filtros['preco']) ? $filtros['preco'] : 'sem-preco'; ?>/<?php echo !empty($filtros['estado']) ? $filtros['estado'] : 'sem-estado'; ?>"><?php echo $q; ?></a></li>
						<?php endfor; ?>
					</ul>
				</div>
			</div>
